...
import { FaBrain, FaSadTear, FaHeartbeat, FaSyncAlt, FaCloud, FaBatteryQuarter, FaBell, FaStar } from 'react-icons/fa';
        ...
        <section className="py-32 bg-[#2b2e4a] text-white">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
              ...
              <a href="tel:0880000000" className="flex justify-center items-center gap-3 px-10 py-5 bg-transparent border-2 border-[#33C5F3] text-white rounded-full font-bold text-lg hover:bg-[#33C5F3]/10 transition-colors w-full sm:w-auto text-center">
                <svg className="w-6 h-6 text-[#33C5F3]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                Bel: 088-XXX XXXX
              </a>
            </div>
          </div>
